...
const InstagramReels = () => {
  ...
  const VIDEO_MAP = {
    ...
    'post_5.mp4': '/videos/napa-friday-drive.mp4',
    'post_6.mp4': '/videos/monday-car-lineup.mp4',
    'post_7.mp4': '/videos/wednesday-napa-sunset.mp4',
    'post_8.mp4': '/videos/saturday-paint-job.mp4',
    'post_9.mp4': '/videos/napa-friday-drive.mp4',
    'post_10.mp4': '/videos/monday-car-lineup.mp4',
  };

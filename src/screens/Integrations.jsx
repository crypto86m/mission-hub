...
const integrations = [
  ...
  { name: "BlueBubbles (iMessage)", category: "Communication", status: "Error", icon: "💬", color: "#007AFF", credentials: "Valid", lastActivity: "Apr 29 11:45 AM", agents: ["Charles (CBV2)"], workflows: ["iMessage relay", "SMS fallback", "Apple ecosystem integration"], models: "N/A", envSource: "/Applications/BlueBubbles.app", note: "🔴 CRITICAL — App in /Trash (4+ hours) | iMessage integration OFFLINE | Fix: Restore app to /Applications" },
  { name: "Cloudflare", category: "Deployment / Infrastructure", status: "Planned", icon: "☁️", color: "#F38020", credentials: "Not configured", lastActivity: "Never", agents: ["N/A"], workflows: ["Tunnel (planned)", "DDoS protection (planned)"], models: "N/A", envSource: "Not set — Tailscale Funnel preferred", note: "⏳ Alternative: Tailscale integration ready in gateway config" },
  ...
  { name: "Discord", category: "Communication", status: "Active", icon: "💬", color: "#5865F2", credentials: "Valid", lastActivity: "Now", agents: ["Discord Bot", "Charles (CBV2)"], workflows: ["Channel monitoring (14 channels)", "Status updates", "Alerts", "Approval notifications"], models: "N/A", envSource: "DISCORD_TOKEN + DISCORD_WEBHOOK", note: "✅ FIXED 2026-04-28 — was 401, now posting to #mac-mini-health-check" },
  { name: "Gmail (OAuth)", category: "Communication", status: "Active", icon: "📧", color: "#EA4335", credentials: "Valid (2 of 3)", lastActivity: "Every 30 min", agents: ["Email Responder"], workflows: ["Auto-reply", "Email triage", "Sensitive flagging"], models: "Haiku for drafting", envSource: "gmail-credentials.json + GMAIL_APP_PASSWORD", note: "✅ crypto86m + charles90bennett WORKING | ⛔ ben86m BROKEN (SMTP 535, needs app password regen)" },
  ...
  { name: "Telegram", category: "Communication", status: "Error", icon: "📩", color: "#0088CC", credentials: "Invalid", lastActivity: "Apr 28 21:43 UTC", agents: ["Charles (CBV2)"], workflows: ["Backup communication channel", "24/7 fallback when Discord down"], models: "N/A", envSource: "Telegram Bot: @CharlesbotV2bot", note: "⛔ BLOCKED 14+ hours — HTTP 403 Forbidden on alerts | Hermes-Monitor silently failing | Benjamin missed all alerts" },

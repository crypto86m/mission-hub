...
const memories = [
  { id: 1, title: 'Live Trading Approved — $500 Account', date: 'April 2, 2026', category: 'Trading Decisions', preview: 'Benjamin approved live trading with $500 capital on Alpaca account 215596978. Three strategies: Bollinger Squeeze QQQ ($250), ORB 30-min QQQ ($150), RSI Extremes SPY ($100). Max daily loss $80.', content: 'Full approval details: Account 215596978, $500 capital. Strategies validated through backtesting. TSLA ORB 30-min: 83 trades, 51.8% WR, +0.094R. Risk parameters: max daily loss $80 (16%), daily target $15-25 (3-5%). Auto-starts via launchd + 15-min watchdog. Capital gate: 6 criteria must pass before scaling.' },
...
export default function MemoryBank() {
  ...
  return (
    <div className="w-full h-full overflow-y-auto pb-24 pt-6 px-4">
      ...
      <p className="text-[10px] text-yellow-400/70 mb-4">ℹ️ Historical snapshots from workspace memory files.</p>
